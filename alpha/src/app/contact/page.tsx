  ...
  return (
    <LegalPage title="Contact" updated="June 2026">
      ...
      <LegalSection heading="Submit an opportunity">
        <p>Anyone can submit a project from the home page&rsquo;s <Link href="/#submit" className="text-[var(--xray-accent)] hover:underline">Submit</Link> section. Submissions run through AI analysis and a GoPlus security check before review.</p>
      </LegalSection>
