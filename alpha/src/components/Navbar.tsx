      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div className="flex flex-col">
              <span className="text-base font-bold tracking-tight text-[var(--xray-text)]">
                TITAN <span className="text-gradient-accent">Alpha</span>
              </span>
          ...
          <div className="hidden md:flex items-center gap-1">
            <a href="#feed" className="px-4 py-2 text-sm font-medium text-[var(--xray-subtext)] hover:text-[var(--xray-text)] rounded-lg hover:bg-[var(--xray-elevated)] transition-all duration-150">
              Alpha Feed
            </a>
            <a href="#submit" className="px-4 py-2 text-sm font-medium text-[var(--xray-subtext)] hover:text-[var(--xray-text)] rounded-lg hover:bg-[var(--xray-elevated)] transition-all duration-150">
              Submit
            </a>
            <a href="#hunters" className="px-4 py-2 text-sm font-medium text-[var(--xray-subtext)] hover:text-[var(--xray-text)] rounded-lg hover:bg-[var(--xray-elevated)] transition-all duration-150">
              Hunters
            </a>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-[var(--xray-border)] bg-[var(--xray-surface)] animate-slide-down">
          <div className="px-4 py-4 flex flex-col gap-1">
            <a href="#feed" className="px-4 py-3 text-sm font-medium text-[var(--xray-subtext)] hover:text-[var(--xray-text)] rounded-lg hover:bg-[var(--xray-elevated)] transition-all">Alpha Feed</a>
            <a href="#submit" className="px-4 py-3 text-sm font-medium text-[var(--xray-subtext)] hover:text-[var(--xray-text)] rounded-lg hover:bg-[var(--xray-elevated)] transition-all">Submit</a>
            <a href="#hunters" className="px-4 py-3 text-sm font-medium text-[var(--xray-subtext)] hover:text-[var(--xray-text)] rounded-lg hover:bg-[var(--xray-elevated)] transition-all">Hunters</a>
