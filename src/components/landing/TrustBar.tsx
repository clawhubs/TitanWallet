...
const TrustBar: React.FC = () => {
  return (
    <div className="w-full border-y border-titan-border titan-deep py-6 px-4">
      <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-x-12 gap-y-6 animate-fade-in animate-delay-400">
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 text-center sm:text-left">
          <span className="text-titan-text font-mono font-bold text-lg sm:text-xl leading-none">9</span>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 text-center sm:text-left">
          <span className="text-titan-text font-mono font-bold text-lg sm:text-xl leading-none">7</span>
          <span className="text-titan-subtext text-[11px] font-semibold uppercase tracking-[0.15em] leading-none">Networks Supported</span>
        </div>
        <div className="hidden sm:block w-px h-6 bg-titan-border" />
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 text-center sm:text-left">
          <span className="text-titan-text font-mono font-bold text-lg sm:text-xl leading-none">Live</span>
          <span className="text-titan-subtext text-[11px] font-semibold uppercase tracking-[0.15em] leading-none">Wallet Creation</span>
        </div>
        <div className="hidden sm:block w-px h-6 bg-titan-border" />
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 text-center sm:text-left">
          <span className="text-titan-text font-mono font-bold text-lg sm:text-xl leading-none">2m</span>
