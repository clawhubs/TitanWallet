...
export const CHAINS: ChainInfo[] = [
  ...
  { id: '0g', name: '0G', shortName: '0G', chainId: 16661, icon: '0G', color: '#00F0FF', explorerUrl: 'https://chainscan.0g.ai', rpcUrl: 'https://evmrpc.0g.ai', rpcEnv: 'ZERO_G_RPC_URL', nativeSymbol: '0G', category: 'popular' },
